            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <div class="add"><a class="input_Addproduct" href="./index.php?chart">Xem biểu đồ</a></div>
                            ...
                            <tbody>
                                ...
                                foreach ($items as $value) { 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="namecategory badge "><?=$gia_min?></span>
                                        </td>

                                        <td>
                                            <span class="namecategory badge "><?=$gia_max?></span>
                                        </td>
                                        <td>
                                            <span class="namecategory badge "><?=$gia_avg?></span>
                                        </td>
                                    </tr>
                                <?php
                                }
...
<script>
    ...
    $('.statistic').addClass('bg-gradient-primary')
</script>
<!-- Github buttons -->
