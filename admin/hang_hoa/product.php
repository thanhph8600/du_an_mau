                      ...
                      echo '
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="./thumb/' . $item['hinh'] . '" class="avatar avatar-xxl me-3 border-radius-lg" alt="user2">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="name">' . $item['ten_hh'] . '</h6>
                              <p class="text-xs text-secondary mb-0"><span>' . $item['ngay_nhap'] . '</span></p>
                            </div>
                          </div>
                        </td>

                        <td>
                          <p class="text-xs font-weight-bold mb-0">' . $item['giam_gia'] . '<span>đ</span></p>
                        </td>

                        <td class="align-middle text-center text-sm">
                          <span class="badge badge-sm bg-gradient-secondary">' . $item['ten_loai'] . '</span>
                        </td>

                        <td class="align-middle">
                          <form action="./addproduct.php" method="get">

                            <input type="hidden" name="slug" value="' . $item['ma_hh'] . '">
