                ...
                <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary opacity-7 ">Đơn giá</th>
                      <th class="text-secondary opacity-7 ">Giảm giá</th>
                      <th class="text-secondary opacity-7 ">Lượt xem</th>
                      ...
                      ?>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="../../uploaded/product/<?=$hinh?>" class="avatar avatar-xxl me-3 border-radius-lg" alt="user2">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="name"><?=$ten_hh?></h6>
                              <p class="text-xs text-secondary mb-0"><span><?=$ngay_nhap?></span></p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td >
                          <p class="text-xl font-weight-bold mb-0 "><?=$giam_gia?></p>
                        </td>
                        <td >
