  ...
  <div class="row">
    <div class="col-12">
      <div class="card my-4">
        ...
        <?= (!empty($value)) ? var_dump($value):'' ?>
        <div class="card-body px-0 pb-2">
          <div class="table-responsive p-0">
            <div class="add"><a class="input_Addproduct" href="./index.php?btn_add">Thêm khách hàng</a></div>
            <table style="width: 90%;margin:auto" class="table align-items-center mb-0">
              <thead>
                <tr class="fs-22">

                  <th class="fs-22 text-uppercase font-weight-bolder text-secondary opacity-7">Tên</th>
              ...
              <tbody > 
                ...
                <?php
                if (isset($khach_hang) && $khach_hang) {
                  ...
                  foreach ($khach_hang as $value) {
                    ...
                    echo '
                        <tr>
                          ...
                          <td>
                            <span class="namecategory badge badge-sm bg-gradient-secondary">' . $value['ho_ten'] . '</span>
                          </td>
                            <td>
                              <span class="namecategory ">' . $value['email'] . '</span>
                            </td>
                            <td>
                              <span class="namecategory ">
                              <img style="width:70px" src="'.$value['hinh'].'" alt="">
                              </span>
                            </td>
                            <td>';
                              ...
                              echo'  <span class="  badge badge-sm bg-success"">Nhân viên</span>';
                               ...
                               echo '  <span class="  badge badge-sm bg-gradient-info"">Khách hàng</span>';
                              }
                          ...
                          <td class="align-middle">
                            <form action="./index.php?btn_edit" method="post">
                              <input type="hidden" name="ma_kh" value="' . $value['ma_kh'] . '">
