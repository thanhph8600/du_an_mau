                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      foreach ($category as $value) {
                        ...
                        <tr>
                          <td>
                            <span class="namecategory badge badge-sm bg-gradient-secondary">' . $value['ten_loai'] . '</span>
                          </td>

                          <td>
                            <span class="namecategory badge ">' . so_luong_sp($value['ma_loai']) . '</span>
                          </td>
                          ...
                          <td class="align-middle">
                            <form action="./index.php?btn_edit" method="post">
                              ...
                              <input name="editCategory" type="submit" value="Sửa" class="text-xs edit">
                          ...
                          <td class="align-middle">
                            <form action="index.php?btn_delete" method="post" onsubmit="return deletecategory()">
                              ...
                              <input type="hidden" name="slug" value="' . $value['ma_loai'] . '">
                              <input name="deleteCategory" type="submit" value="Xóa" class="text-xs delete">
                            </form>
                          </td>
                        </tr>';
                      }
