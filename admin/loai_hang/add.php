      ...
      <div class="card my-4">
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive p-0">
            <form action="index.php?btn_insert" method="post" onsubmit="return checkcategory()" style="display:flex;width:95%;margin:auto">
              <label for="" class=" fs-5 text">Tên danh mục sản phẩm</label>
              <input name="namecategory" type="text" id="namecategory" value="">
...
<script>
  ...
  function checkcategory(){
    if($("#namecategory").val() == ''){
      $('.ket-qua').html('<div class="alert alert-warning text-white " role="alert">Thêm sản phẩm thất bại</div>')
      $("#namecategory").css('border', '1px solid red')
      check =1;
    }
    if(check == 1){
