            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Tổng hợp đơn hàng</h6>
                    </div>
                </div>
                        ...
                        <table style="width: 90%;margin:auto" class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                foreach ($items as $value) { 
                                    ...
                                    <tr>
                                        <td>
                                            <span class="namecategory badge badge-sm bg-gradient-secondary"><?=$ma_order?></span>
                                        </td>

                                        <td>
                                            <span class="namecategory badge "><?=$ten_kh?></span>
                                        </td>

                                        <td>
                                            <span class="namecategory badge "><?=currency_format($tong_tien)?></span>
                                        </td>

                                        <td>
                                            <span class="namecategory badge "><?=tinh_trang_don_hang($tinh_trang)?></span>
                                        </td>

                                        <td class="align-middle">
                                            <form action="./index.php?chi_tiet" method="post">
                                                <input type="hidden" name="ma_order" value="<?=$ma_order?>">
