    ...
    <div class="container m-auto py-8">
        <div class="flex">
            ...
            <div class=" w-1/2">
                ...
                <h3 class=" text-red-600 font-bold text-2xl py-2">
                    <?= currency_format($sanpham['don_gia'] - $sanpham['don_gia'] * $sanpham['giam_gia'])
                    ?>
                    <span class=" line-through text-gray-600 font-normal text-base"> <?= currency_format($sanpham['don_gia']) ?> </span>
                </h3>
                <div class=" py-3">
                    <button class="add-shopcart transition ease-in-out duration-500 w-3/6 py-2 rounded-lg hover:shadow-lg text-orange-600 border border-orange-600 hover:bg-orange-600 hover:text-white text-lg">Thêm vào giỏ hàng <i class="fa fa-shopping-cart" aria-hidden="true"></i></button>
