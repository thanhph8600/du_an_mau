...
if (exist_parma('gui_email_don_hang')) {
    ...
    try {
        ...
        $mail->Body    = '
        <p>Xin chào ' . $name . ', <br>
        Chúng tôi đã nhận được yêu cầu về đơn hàng của bạn. <br>
        Mã đơn hàng của bạn là: <br></p>
        <span style="padding:15px;border:1px grey solid;font-size:22px">' . $ma_order . '</span>
